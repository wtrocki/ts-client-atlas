...
export class AtlasSearchApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createAtlasSearchIndex(groupId: string, clusterName: string, fTSIndex: FTSIndex, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'fTSIndex' is not null or undefined
        if (fTSIndex === null || fTSIndex === undefined) {
            throw new RequiredError("AtlasSearchApi", "createAtlasSearchIndex", "fTSIndex");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(fTSIndex, "FTSIndex", ""),
            contentType
        );
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async deleteAtlasSearchIndex(groupId: string, clusterName: string, indexId: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async getAtlasSearchIndex(groupId: string, clusterName: string, indexId: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async listAtlasSearchIndexes(groupId: string, clusterName: string, collectionName: string, databaseName: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async updateAtlasSearchIndex(groupId: string, clusterName: string, indexId: string, fTSIndex: FTSIndex, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'fTSIndex' is not null or undefined
        if (fTSIndex === null || fTSIndex === undefined) {
            throw new RequiredError("AtlasSearchApi", "updateAtlasSearchIndex", "fTSIndex");
        }
...
export class AtlasSearchApiResponseProcessor {
     ...
     */
     public async createAtlasSearchIndex(response: ResponseContext): Promise<FTSIndex > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FTSIndex = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteAtlasSearchIndex(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getAtlasSearchIndex(response: ResponseContext): Promise<FTSIndex > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FTSIndex = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listAtlasSearchIndexes(response: ResponseContext): Promise<Array<FTSIndex> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<FTSIndex> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "Array<FTSIndex>", ""
            ) as Array<FTSIndex>;
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateAtlasSearchIndex(response: ResponseContext): Promise<FTSIndex > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: FTSIndex = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
