...
export class RollingIndexApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createRollingIndex(groupId: string, clusterName: string, apiIndexRequestView: ApiIndexRequestView, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'apiIndexRequestView' is not null or undefined
        if (apiIndexRequestView === null || apiIndexRequestView === undefined) {
            throw new RequiredError("RollingIndexApi", "createRollingIndex", "apiIndexRequestView");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(apiIndexRequestView, "ApiIndexRequestView", ""),
            contentType
        );
