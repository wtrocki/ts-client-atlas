...
export class SharedTierSnapshotsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async downloadSharedClusterBackup(clusterName: string, groupId: string, tenantRestore: TenantRestore, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async getSharedClusterBackup(groupId: string, clusterName: string, snapshotId: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async listSharedClusterBackups(groupId: string, clusterName: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class SharedTierSnapshotsApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSharedClusterBackup(response: ResponseContext): Promise<TenantSnapshot > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: TenantSnapshot = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "TenantSnapshot", ""
            ) as TenantSnapshot;
            return body;
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listSharedClusterBackups(response: ResponseContext): Promise<PaginatedTenantSnapshotView > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: PaginatedTenantSnapshotView = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "PaginatedTenantSnapshotView", ""
            ) as PaginatedTenantSnapshotView;
            return body;
        }
        if (isCodeInRange("400", response.httpStatusCode)) {
            const body: ApiError = ObjectSerializer.deserialize(
