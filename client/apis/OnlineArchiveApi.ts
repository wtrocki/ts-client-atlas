...
export class OnlineArchiveApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createOnlineArchive(groupId: string, clusterName: string, onlineArchive: OnlineArchive, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'onlineArchive' is not null or undefined
        if (onlineArchive === null || onlineArchive === undefined) {
            throw new RequiredError("OnlineArchiveApi", "createOnlineArchive", "onlineArchive");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(onlineArchive, "OnlineArchive", ""),
            contentType
        );
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async deleteOnlineArchive(groupId: string, archiveId: string, clusterName: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async downloadOnlineArchiveQueryLogs(groupId: string, clusterName: string, envelope?: boolean, startDate?: number, endDate?: number, archiveOnly?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async getOnlineArchive(groupId: string, archiveId: string, clusterName: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async listOnlineArchives(groupId: string, clusterName: string, envelope?: boolean, includeCount?: boolean, itemsPerPage?: number, pageNum?: number, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async updateOnlineArchive(groupId: string, archiveId: string, clusterName: string, onlineArchive: OnlineArchive, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'onlineArchive' is not null or undefined
        if (onlineArchive === null || onlineArchive === undefined) {
            throw new RequiredError("OnlineArchiveApi", "updateOnlineArchive", "onlineArchive");
        }
...
export class OnlineArchiveApiResponseProcessor {
     ...
     */
     public async createOnlineArchive(response: ResponseContext): Promise<OnlineArchive > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OnlineArchive = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteOnlineArchive(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getOnlineArchive(response: ResponseContext): Promise<OnlineArchive > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OnlineArchive = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listOnlineArchives(response: ResponseContext): Promise<PaginatedOnlineArchiveView > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: PaginatedOnlineArchiveView = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "PaginatedOnlineArchiveView", ""
            ) as PaginatedOnlineArchiveView;
            return body;
        }
        if (isCodeInRange("401", response.httpStatusCode)) {
            const body: ApiError = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateOnlineArchive(response: ResponseContext): Promise<OnlineArchive > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: OnlineArchive = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
