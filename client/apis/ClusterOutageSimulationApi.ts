...
export class ClusterOutageSimulationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async endOutageSimulation(groupId: string, clusterName: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async getOutageSimulation(groupId: string, clusterName: string, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     * @param pretty Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
     */
    public async startOutageSimulation(groupId: string, clusterName: string, clusterOutageSimulation: ClusterOutageSimulation, envelope?: boolean, pretty?: boolean, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
