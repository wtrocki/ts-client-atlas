...
let body:.AlertsApiListAlertsRequest = {
  ...
  // boolean | Flag that indicates whether the response body should be in the <a href=\"https://en.wikipedia.org/wiki/Prettyprint\" target=\"_blank\" rel=\"noopener noreferrer\">prettyprint</a> format. (optional)
  pretty: false,
  // 'OPEN' | 'TRACKING' | 'CLOSED' | Status of the alerts to return. Omit to return all alerts in all statuses. (optional)
  status: "OPEN",
};
...
> PaginatedAlertView listAlertsByAlertConfigurationId()
