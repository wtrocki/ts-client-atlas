...
# **createUser**
> CloudAppUser createUser(cloudAppUser)
...
let body:.MongoDBCloudUsersApiCreateUserRequest = {
  // CloudAppUser | MongoDB Cloud user account to create.
  cloudAppUser: {
    country: "AE",
...
------------- | ------------- | ------------- | -------------
 **cloudAppUser** | **CloudAppUser**| MongoDB Cloud user account to create. |
...
# **getUserByUsername**
> CloudAppUser getUserByUsername()
