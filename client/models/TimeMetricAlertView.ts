...
export class TimeMetricAlertView {
    /**
    ...
    */
    'status': TimeMetricAlertViewStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "TimeMetricAlertViewStatusEnum",
            "format": ""
        },
        {
            "name": "updated",
...
export type TimeMetricAlertViewStatusEnum = "CANCELLED" | "CLOSED" | "OPEN" | "TRACKING" ;
