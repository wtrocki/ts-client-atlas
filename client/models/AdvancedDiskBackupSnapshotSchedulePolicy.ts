...
*/
export class AdvancedDiskBackupSnapshotSchedulePolicy {
    /**
    ...
    */
    ...
    'policyItems'?: Array<DiskBackupApiPolicyItem>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "Array<DiskBackupApiPolicyItem>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return AdvancedDiskBackupSnapshotSchedulePolicy.attributeTypeMap;
    }
