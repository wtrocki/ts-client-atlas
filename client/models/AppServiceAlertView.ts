...
*/
export class AppServiceAlertView {
    /**
    ...
    */
    'status': AppServiceAlertViewStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "AppServiceAlertViewStatusEnum",
            "format": ""
        },
        {
            "name": "updated",
...
export type AppServiceAlertViewStatusEnum = "CANCELLED" | "CLOSED" | "OPEN" | "TRACKING" ;
