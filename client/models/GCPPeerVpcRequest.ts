...
export class GCPPeerVpcRequest {
    /**
    ...
    */
    'providerName': GCPPeerVpcRequestProviderNameEnum;
    /**
    ...
    */
    'status'?: GCPPeerVpcRequestStatusEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "GCPPeerVpcRequestProviderNameEnum",
            "format": ""
        },
        {
            "name": "errorMessage",
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "GCPPeerVpcRequestStatusEnum",
            "format": ""
        }    ];
...
export type GCPPeerVpcRequestProviderNameEnum = "AWS" | "AZURE" | "GCP" ;
export type GCPPeerVpcRequestStatusEnum = "ADDING_PEER" | "WAITING_FOR_USER" | "AVAILABLE" | "FAILED" | "DELETING" ;
