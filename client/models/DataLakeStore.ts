...
export class DataLakeStore {
    ...
    */
    'additionalStorageClasses'?: Array<DataLakeStoreAdditionalStorageClassesEnum>;
    /**
    ...
    */
    'region'?: DataLakeStoreRegionEnum;
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<DataLakeStoreAdditionalStorageClassesEnum>",
            "format": ""
        },
        {
            "name": "bucket",
