...
*/
export class GreaterThanTimeThresholdView {
    /**
    * Comparison operator to apply when checking the current metric value.
    */
    'operator'?: GreaterThanTimeThresholdViewOperatorEnum;
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "operator",
            "baseName": "operator",
            "type": "GreaterThanTimeThresholdViewOperatorEnum",
            "format": ""
        },
        {
            "name": "threshold",
...
export type GreaterThanTimeThresholdViewOperatorEnum = "GREATER_THAN" ;
