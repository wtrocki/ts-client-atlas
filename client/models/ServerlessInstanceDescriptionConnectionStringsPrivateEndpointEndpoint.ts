...
*/
export class ServerlessInstanceDescriptionConnectionStringsPrivateEndpointEndpoint {
    /**
...
export type ServerlessInstanceDescriptionConnectionStringsPrivateEndpointEndpointProviderNameEnum = "AWS" | "AZURE" ;
