...
export class CloudProviderRegions {
    /**
    * List of instances sizes that this cloud provider supports.
    */

    'instanceSizes'?: Array<ClusterCloudProviderInstanceSize>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<ClusterCloudProviderInstanceSize>",
            "format": ""
        },
        {
            "name": "provider",
    ...
    static getAttributeTypeMap() {
        return CloudProviderRegions.attributeTypeMap;
    }
