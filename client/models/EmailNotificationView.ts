...
*/
export class EmailNotificationView {
    /**
    ...
    */
    'typeName': EmailNotificationViewTypeNameEnum;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "typeName",
            "baseName": "typeName",
            "type": "EmailNotificationViewTypeNameEnum",
            "format": ""
        }    ];
...
export type EmailNotificationViewTypeNameEnum = "EMAIL" ;
