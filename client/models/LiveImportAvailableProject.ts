...
export class LiveImportAvailableProject {
    /**
    * List of clusters that can be migrated to MongoDB Cloud.
    */

    'deployments'?: Array<AvailableClustersDeployment>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<AvailableClustersDeployment>",
            "format": ""
        },
        {
            "name": "migrationHosts",
    ...
    static getAttributeTypeMap() {
        return LiveImportAvailableProject.attributeTypeMap;
    }
