...
export class PerformanceAdvisorShape {
    /**
    ...
    */
    ...
    'operations'?: Array<PerformanceAdvisorOperation>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "operations",
            "baseName": "operations",
            "type": "Array<PerformanceAdvisorOperation>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PerformanceAdvisorShape.attributeTypeMap;
    }
