...
export class RawMetricAlertView {
    /**
    ...
    */
    'status': RawMetricAlertViewStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "RawMetricAlertViewStatusEnum",
            "format": ""
        },
        {
            "name": "updated",
...
export type RawMetricAlertViewStatusEnum = "CANCELLED" | "CLOSED" | "OPEN" | "TRACKING" ;
