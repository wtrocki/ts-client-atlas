...
*/
export class GreaterThanDaysThresholdView {
    /**
...
export type GreaterThanDaysThresholdViewOperatorEnum = "GREATER_THAN" ;
export type GreaterThanDaysThresholdViewUnitsEnum = "DAYS" ;
