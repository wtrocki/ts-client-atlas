...
*/
export class ClusterCloudProviderInstanceSize {
    /**
    * List of regions that this cloud provider supports for this instance size.
    */

    'availableRegions'?: Array<AvailableCloudProviderRegion>;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<AvailableCloudProviderRegion>",
            "format": ""
        },
        {
            "name": "name",
    ...
    static getAttributeTypeMap() {
        return ClusterCloudProviderInstanceSize.attributeTypeMap;
    }
