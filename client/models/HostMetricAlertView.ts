...
*/
export class HostMetricAlertView {
    /**
    ...
    */
    'status': HostMetricAlertViewStatusEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "HostMetricAlertViewStatusEnum",
            "format": ""
        },
        {
            "name": "updated",
    ...
    public constructor() {
        this.metricName = "HostMetricAlertView";
    }
}


export type HostMetricAlertViewStatusEnum = "CANCELLED" | "CLOSED" | "OPEN" | "TRACKING" ;
